""" Testing spinbox for quantity of each food
Salmon sushi food is used for testing before other foods are added.
"""
...
class Takeaway:
    ...
    def __init__(self):
        ...
        """
        # self.num_list variable contains all accepted variables for quantity spinbox
        self.num_list = []
        # if range=100 then list starts at 0 and ends at 99, but we want 0-100
        for i in range(101):
        ...
        self.food1_quantity_spinbox = Spinbox(self.food1_frame, from_=0, to=100, increment="1", value=self.num_list, format="%.0f", fg=font_color, font=normal_font, textvariable=self.food1_quantity, justify="center", width=4, wrap=True)
